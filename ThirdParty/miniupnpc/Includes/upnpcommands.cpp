		    ...
		    const char * leaseDuration)
{
	...
	AddPortMappingArgs = (UPNParg*)calloc(9, sizeof(struct UPNParg));
                       ...
                       const char * remoteHost)
{
	...
	DeletePortMappingArgs = (UPNParg*)calloc(4, sizeof(struct UPNParg));
			    ...
			    const char * manage)
{
	...
	DeletePortMappingArgs = (UPNParg*)calloc(5, sizeof(struct UPNParg));
	if(DeletePortMappingArgs == NULL)
		return UPNPCOMMAND_MEM_ALLOC_ERROR;
							 ...
							 char * duration)
{
	...
	intClient[0] = '\0';
	intPort[0] = '\0';
	GetPortMappingArgs = (UPNParg*)calloc(2, sizeof(struct UPNParg));
                                 ...
                                 char * leaseDuration)
{
	...
	GetPortMappingArgs = (UPNParg*)calloc(4, sizeof(struct UPNParg));
	if(GetPortMappingArgs == NULL)
		return UPNPCOMMAND_MEM_ALLOC_ERROR;
                           ...
                           struct PortMappingParserData * data)
{
	...
	GetListOfPortMappingsArgs = (UPNParg*)calloc(6, sizeof(struct UPNParg));
                    ...
                    int * opTimeout)
{
	...
	GetOutboundPinholeTimeoutArgs = (UPNParg*)calloc(6, sizeof(struct UPNParg));
                    ...
                    char * uniqueID)
{
	...
	AddPinholeArgs = (UPNParg*)calloc(7, sizeof(struct UPNParg));
                    ...
                    const char * leaseTime)
{
	...
	UpdatePinholeArgs = (UPNParg*)calloc(3, sizeof(struct UPNParg));
...
UPNP_DeletePinhole(const char * controlURL, const char * servicetype, const char * uniqueID)
{
	...
	DeletePinholeArgs = (UPNParg*)calloc(2, sizeof(struct UPNParg));
                                 ...
                                 const char * uniqueID, int * isWorking)
{
	...
	CheckPinholeWorkingArgs = (UPNParg*)calloc(4, sizeof(struct UPNParg));
                                 ...
                                 const char * uniqueID, int * packets)
{
	...
	GetPinholePacketsArgs = (UPNParg*)calloc(4, sizeof(struct UPNParg));
